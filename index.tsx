...
Составь КОМПАКТНУЮ, но информативную сводку того, что произошло, пока пользователь не читал сообщения. 
Правила:
...
10. КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО использовать Markdown-заголовки (#, ##, ###).
